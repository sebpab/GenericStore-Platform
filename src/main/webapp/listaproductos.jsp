				...
				if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
					...
					for (i = 0; i < usuarios.length; i++) {
						let fila = [
							...
							usuarios[i].iva_compra.toString(), 
							usuarios[i].nit_proveedor.toString(), 
							usuarios[i].nombre_producto, 
							usuarios[i].precio_compra.toString(),
							usuarios[i].precio_venta.toString()
						];
			...
			<div
				...
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item active">Muestra un listado de todos
						los productos que se encuentran registrados</li>
				</ol>
					...
					<div class="col-xl-12">
						<div class="card mb-4">
							<div class="card-header text-white bg-dark">
								<i class="fas fa-table"></i> Listado de Productos
								</div>
								<div class="card-body">
