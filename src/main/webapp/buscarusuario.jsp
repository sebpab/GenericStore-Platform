		...
		<main>
			<div
				...
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item active">Permite buscar un usuario
						existente</li>
				</ol>
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="card mb-4">
							<div class="card-header text-white bg-dark">
								<i class="fas fa-table"></i> Formulario de busqueda de usuario
							</div>
							<div class="card-body">

								<h1>
									<i class="fas fa-search m-1"></i>Cedula del usuario a buscar
								</h1>
								...
								<div class="container">
									...
									<div class="container">
										...
										<div id="correcto" class="alert alert-success visually-hidden"
											role="alert">Usuario encontrado con exito.  Resultados en la
											sección de abajo.</div>
										...
										<form id="form1">
											...
											class="fas fa-search"></i> Buscar usuario
											</button>
											<br>			
											<br> <br>
											<div class="input-group mb-3">
